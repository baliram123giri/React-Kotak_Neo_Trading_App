...
export const DashboardSearch = (props: Props) => {
    ...
    return (
        <View style={{ height: HP(10), marginTop: top, paddingHorizontal: WP(4.5) }} className='border-b-2 flex-row items-center justify-between border-b-neutral-300'>
            <View style={{ width: WP(65) }} className='border-neutral-200 border pl-1 rounded-xl h-[50%] flex-row items-center justify-between'>
            ...
            <TouchableOpacity className='rounded-xl flex-row justify-center items-center p-1 px-2' style={{ height: HP(4.5), backgroundColor: lighGray, gap:WP(1.5) }}>
